...
export function LinkedInLogo({ size = 16 }: LogoProps) {
  return (
...
export function InstagramLogo({ size = 16 }: LogoProps) {
...
export function FacebookLogo({ size = 16 }: LogoProps) {
  return (
...
export function YouTubeLogo({ size = 16 }: LogoProps) {
  return <SquarePlay size={size} color="#FF0000" strokeWidth={1.75} />;
}
